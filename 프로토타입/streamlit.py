...
# --------------------------------------------------------------------------------- 
# Page1 data 작업
data = pd.read_csv("프로토타입/프로토타입_1페이지.csv")
data = data[['지번주소', '연식', '탄소/연면적','작년 탄소 배출량 월평균', '주변 평균', '사용승인 연도','지붕코드명', '구조코드명', '구 이름', '건물명',
             '건축면적(㎡)','지상층수', '연면적(㎡)', '에너지절감율', '사용승인일','통합용도명', '위도', '경도', '동 이름', '2401 탄소 예측량','건축면적(㎡)_y', 
             '지상층수.1', '지하층수', '연면적(㎡)_y', '그린리모델링진행', '사용승인일_y']]     
                    ...
                    html= """<!DOCTYPE html>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <a href="http://localhost:8503" target="_blank">공문 보내기</a>
                        </tbody > </table>
                    </body>
                    </html> """
...
# streamlit run 프로토타입\streamlit.py
